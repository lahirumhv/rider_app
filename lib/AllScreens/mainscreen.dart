...
class _MainScreenState extends State<MainScreen> with TickerProviderStateMixin {
  ...
  void displyRideDetailsContainer() async {
    await getPlaceDirection();

    setState(() {
      searchContainerHeight = 0;
      rideDetailsContainerHeight = 240.0;
      bottomPadingOfMap = 240.0;
      drawerOpen = false;
    });
  }
  ...
  void locatePosition() async {
    //Find appropriate location acuracy setting later
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              Text(
                                ((tripDirectionDetails != null)
                                    ? "\$${AssistantMethods.calculateFares(tripDirectionDetails!).toString()}"
                                    : ""),
  ...
  Future<void> getPlaceDirection() async {
    ...
    Marker pickUpLocationMarker = Marker(
      ...
      infoWindow: InfoWindow(
        ...
        // snippet: initialPosition.placeFormattedAddress,
        snippet: "my Location",
      ),
    ...
    Marker dropOffLocationMarker = Marker(
      ...
      infoWindow: InfoWindow(
        ...
        // snippet: finalPosition.placeFormattedAddress,
    ...
    setState(() {
      circlesSet.add(pickUpLoCircle);
      circlesSet.add(dropOffLoCircle);
    });
  }
}
